...
{
    class Day13 : IAdventDayPuzzle
    {
        public string Description => @"You reach another volcanically active part of the cave. It would be nice if you could do some kind of thermal imaging so you could tell ahead of time which caves are too hot to safely enter.
...
Apparently, the Elves have never used this feature. To your surprise, you manage to find the manual; as you go to open it, page 1 falls out. It's a large sheet of transparent paper! The transparent paper is marked with random dots and includes instructions on how to fold it up (your puzzle input).";
        ...
        public DateTime Date => new DateTime(2021, 12, 13);
        ...
        {
            private readonly (int X, int Y)[] _dots;
            private readonly (int X, int Y) _instruction;

            public Solution1((int X, int Y)[] dots, (int X, int Y) foldInstruction)
            {
                _dots = dots;
                _instruction = foldInstruction;
            }

            public string Description => @"How many dots are visible after completing just the first fold instruction on your transparent paper?";
            public int Part => 1;
            public object Solve()
            {
        ...
        {
            private readonly (int X, int Y)[] _dots;
            private readonly (int X, int Y)[] _instructions;

            public Solution2((int X, int Y)[] dots, (int X, int Y)[] foldInstructions)
            {
                _dots = dots;
                _instructions = foldInstructions;
            }

            public string Description => @"Finish folding the transparent paper according to the instructions. The manual says the code is always eight capital letters.
...
What code do you use to activate the infrared thermal imaging camera system?";
        ...
        internal static (int X, int Y)[] FoldInstructions => new (int X, int Y)[]
        {
            (655, 0),
            (0, 447),
            (327, 0),
        ...
        internal static (int X, int Y)[] Dots => new (int X, int Y)[]
        {
            (1141, 761),
            (175, 114),
            (628, 854),
